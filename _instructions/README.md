...
| [02-architecture](02-architecture.md) | Структура проекту, потік даних, Blazor Server, БД, GitHub API |
| [03-data-models](03-data-models.md) | Всі сутності БД, UI моделі, індекси |
| [04-services](04-services.md) | Що робить кожен сервіс, EnsureLinkedAsync, ExecuteUpdateAsync |
